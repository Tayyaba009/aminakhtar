...
if (isset($_POST['LogIn'])){
    ...
    $db->where("ConsumerPassword",  md5(trim($_POST['password'])) );
    ...
    if (sizeof($user) > 0){
      ...
      $_SESSION['ConsumerId'] =$user[0]['ConsumerId'] ;
...
{
  echo  '<p class="alert alert-danger">Login Failed <br>Invalid Email or Password</p>' . " \n";
  }
                        ...
                        <div class="ac-overview">
                            <div class="pera-dec">
                                <div class="applicant-from">
                                    <form id="scheduletourfrom" action="Login.php" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                             ...
                                             <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="password" class="form-control" id="password" required="required" data-error="Please enter your name" placeholder="">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>

                                            <div class="col-lg-12 col-md-12">
                                                <button type="submit" name = "LogIn" value = "submit" class="default-btn">Login Now</button>
